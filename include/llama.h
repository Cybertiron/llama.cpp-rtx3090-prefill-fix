...
extern "C" {
    ...
    // Experimental structured K/V cache (KVarN, ported from Anbeeld/beellama.cpp).
    // Unlike a conventional ggml cache type, KVarN stores joint 128-token tiles and
    // therefore has a separate context parameter object.
