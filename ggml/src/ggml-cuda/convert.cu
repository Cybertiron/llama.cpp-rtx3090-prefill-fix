...
to_bf16_cuda_t ggml_get_to_bf16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q3_0:
            return dequantize_block_cont_cuda<QK3_0, QR3_0, dequantize_q3_0>;
        case GGML_TYPE_Q2_0S:
            return dequantize_block_cont_cuda<QK2_0S, QR2_0S, dequantize_q2_0s>;
        case GGML_TYPE_Q4_0:
...
to_fp16_nc_cuda_t ggml_get_to_fp16_nc_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_Q3_0:
            return dequantize_block_cuda<QK3_0, QR3_0, dequantize_q3_0>;
        case GGML_TYPE_Q2_0S:
            return dequantize_block_cuda<QK2_0S, QR2_0S, dequantize_q2_0s>;
        case GGML_TYPE_Q4_0:
